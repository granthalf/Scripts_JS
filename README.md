...
1. Directory {MONKEY_SCRIPTS} => ACTIVATE SCRIPTS JS IN ORDRER TO CRAWL EASIER ON THE WEB (IN ANY 'MONKEY' EXTENSION)
  ...
  G. GenKeys-2026-04-06.user.js
    The Generator-Keys Script: when you activate it, you download 2 files as "1 Public Key" & "1 Private Key". To use mainly with the Text Cryptor.

  H. CryptText-2026-04-06.user.js
    The Text Cryptor Script: when you activate it, you encrypt a text or decrypt it. To use with Keys generated by GenKeys.
